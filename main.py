  ...
  if ret:
    ...
    for plate in plates.boxes.data.tolist():
      ...
      if car_id != -1:
        ...
        license_crop_thresh = cv2.threshold(license_crop, 64, 255, cv2.THRESH_BINARY_INV)[1]
        ...
        # frame = visualize(frame, (car_x1, car_y1, car_x2, car_y2), (x1, y1, x2, y2) , license_crop)
